...
# Combine two hex files
function(merge_hex target hex_file)
    add_custom_command(TARGET ${target} POST_BUILD
        COMMAND mergehex -m "${CMAKE_CURRENT_BINARY_DIR}/${target}.hex" "${hex_file}" -o "${CMAKE_CURRENT_BINARY_DIR}/${target}_sd.hex")
endfunction()
